...
export const connectRouter = (mapURLParamsToProps = noop, queryUpdaters = {}) => (
  ...
  withRouter(({ location: { query, pathname }, match: { params }, history, ...rest }) => {
    ...
    Object.keys(queryUpdaters).forEach((key) => {
      mappedUpdaters[key] = (...args) =>
        history.replace(mergeLocation(queryUpdaters[key](...args)));
    });

    return <WrappedComponent {...mappedProps} {...mappedUpdaters} {...rest} />;
  });
