...
storiesOf('Components/Buttons/ghostButton', module)
  ...
  .add('with text', () => <GhostButton>Button title</GhostButton>)
  .add('with icon', () => <GhostButton icon={TestIcon} />)
  .add('with icon & text', () => <GhostButton icon={TestIcon}>Button title</GhostButton>)
  .add('disabled with text', () => <GhostButton disabled>Button title</GhostButton>)
